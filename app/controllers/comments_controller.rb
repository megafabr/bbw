class CommentsController < ApplicationController
  ...
  def notify_subscribers(event, comment)
    ...
    all_emails =
      ...
      #(event.subscriptions.map do |subscription|
      #  if current_user.nil?
      #    unless user_email == subscription.user_email
      #      user_email
      #    end
      #  else
      #    unless current_user.email == subscription.user_email
      #      subscription.user_email
      #    end
      #  end
      #end + [event.user.email]).uniq
