Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "bbw_#{Rails.env}"
  ...
  # ПРОПИСЫВАЙТЕ свой!
  config.action_mailer.default_url_options = {host: 'fabrbbq.herokuapp.com'}
  ...
  ActionMailer::Base.smtp_settings = {
    ...
    :user_name      => ENV['app155865463@heroku.com'],
    :password       => ENV['ygfg9wtj4739'],
    :domain         => 'heroku.com',
